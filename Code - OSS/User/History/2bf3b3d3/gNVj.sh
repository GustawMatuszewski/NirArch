...
SELECT=$(echo -e "$ACTIONS" | wofi --dmenu --style ~/.config/wofi/style.css --width 300 --height 220 --location center --hide-input --prompt "Audio Control")
...
case "$SELECT" in
    ...
    *"Switch Output"*)
        ...
        CHOICE=$(echo "$MENU_OPTIONS" | wofi --dmenu --style ~/.config/wofi/style.css --width 450 --height 350 --location center --hide-input --prompt "Select Device")
